  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-multi': 'linear-gradient(135deg, #00AE98, #33BFAE, #8E8E8E, #707070)',
        'gradient-border': 'linear-gradient(135deg, #00AE98, #33BFAE, #8E8E8E, #707070)',
        'gradient-diagonal': 'linear-gradient(45deg, #00AE98, #33BFAE, #8E8E8E, #707070)',
      },
      transitionProperty: {
        'height': 'height',
...

{
  plugins: [
    ...
    'tailwindcss-animate',
    'tailwindcss-animated', // Add tailwindcss-animated plugin here
  ]
}
